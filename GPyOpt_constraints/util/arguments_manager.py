...
from ..acquisitions import AcquisitionEI, AcquisitionMPI, AcquisitionLCB, AcquisitionEI_MCMC, AcquisitionMPI_MCMC, AcquisitionLCB_MCMC, AcquisitionLP, AcquisitionConstrainedEI # Aleks edit
...
class ArgumentsManager(object):
    ...
    def acquisition_creator(self, acquisition_type, model, space, acquisition_optimizer,cost_withGradients):
        ...
        constraint_function = self.kwargs.get('constraint_function') # Aleks edit
        ...
        elif acquisition_type =='constrained_EI': # Aleks edit
            return AcquisitionConstrainedEI(model, space, constraint_function, acquisition_optimizer, cost_withGradients, acquisition_jitter) # Aleks edit
